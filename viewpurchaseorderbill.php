...
if(isset($_POST['submit']))
{
	...
	else
	{
		...
		$sqlins="INSERT INTO `purchase_order`(`product_id`, `purchase_request_id`, `customer_id`, `seller_id`, `purchase_order_date`, `purchase_order_time`, `purchase_amt`, `quantity`, `status`) VALUES ('$_POST[product_id]','$_POST[purchase_request_id]','$_POST[customer_id]','$_SESSION[sellerid]','$_POST[request_date]','$_POST[request_time]','$_POST[price]','$_POST[qty]','Pending')";
		...
		<center><h4>View Purchase Request Detail...</h4></center><hr>
							...
							<table class="table table-striped table-bordered"  style="width:100%">
						      ...
						      <th><strong>Status</strong></th>
								...
								<TBODY>
<?php
							  $sql = "SELECT *,purchase_request.quantity as purreqqty,purchase_request.status as purreqstatus FROM purchase_request INNER JOIN product ON product.product_id=purchase_request.product_id  WHERE product.seller_id='$_SESSION[sellerid]' AND purchase_request.purchase_request_id='$_GET[purchaserequestid]'";
							  $qsql = mysqli_query($con,$sql);
 ...
 <tbody>
        ...
        <tr>
		 ...
		 $rspro = mysqli_fetch_array($qsqlproduct);
		  ...
		  ?>)</td>
          <td><input type="text" name="qty" id="qty" value="<?php echo $rs['purreqqty']; ?>" readonly class="form-control"></td>
        </tr>
        <tr>
          <td>Price:&nbsp;</td>
