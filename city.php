...
if($_SESSION['randnumber']  == $_POST['randnumber'])
{
	if(isset($_POST['submit']))
	{
		...
		{
			$sql ="UPDATE city SET   `state_id`='$_POST[state]', `city`='$_POST[city]', `description`='" .  mysqli_real_escape_string($con,$_POST['description']) . "', `status`='$_POST[status]' WHERE city_id='$_GET[editid]'";
		...
		{
			$sql="INSERT INTO `city`(`city_id`, `state_id`, `city`, `description`, `status`) VALUES ('','$_POST[state]','$_POST[city]','" .  mysqli_real_escape_string($con,$_POST['description']) . "','$_POST[status]')";	
			if(!mysqli_query($con,$sql))
			{
