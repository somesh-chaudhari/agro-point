...
if(isset($_POST['submit']))
{
	...
	{
		$sql ="UPDATE produce SET  `category_id`='$_POST[category]', `produce`='$_POST[produce]', `description`='" .  mysqli_real_escape_string($con,$_POST['description']) . "', `img`='$imgname1', `status`='$_POST[status]'  WHERE produce_id='$_GET[editid]'";
	...
	{
	$sql="INSERT INTO `produce`( `category_id`, `produce`, `description`, `img`, `status`) VALUES ('$_POST[category]','$_POST[produce]','" .  mysqli_real_escape_string($con,$_POST['description']) . "','$imgname1','$_POST[status]')";	
