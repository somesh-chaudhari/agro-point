...
if(isset($_POST['submit']))
{
	...
	{
		$sql ="UPDATE state SET `state`='$_POST[state]', `description`='" .  mysqli_real_escape_string($con,$_POST['description']) . "', `status`='Active' where state_id='$_GET[editid]'";
	...
	{
		$sql="INSERT INTO `state`( `state`, `description`, `status`) VALUES ('$_POST[state]','" .  mysqli_real_escape_string($con,$_POST['description']) . "','Active')";	
		if(!mysqli_query($con,$sql))
		{
			echo "Error in mysqli query";
		}
